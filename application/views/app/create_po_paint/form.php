...
$(function(){
	...
	createForm({
		...
		backPage		: "create_po_paint",
		nextPage		: "create_po_paint/form"
	});
	createLookUp({
	...
	var otb = createTableFormTransient({
		id 				: "#transient_detail",
		listSource 		: "create_po_paint/detail_table_loader/"+$('input[name="i_stand_id"]').val()+"/<?=$row_id?>",
		formSource 		: "create_po_paint/detail_form/<?=$row_id?>",
		printTarget		: "create_po_paint/print_doc",
		controlTarget	: "create_po_paint/detail_form_action"
	});
