...
$(function(){
	...
	createForm({
		...
		backPage		: "po_received",
		nextPage		: "po_received"
	});
	...
	var otb = createTableFormTransient({
		id 				: "#transient_detail",
		listSource 		: "po_received/detail_table_loader/"+$('input[name="i_registration_id"]').val()+"/<?=$row_id?>",
		formSource 		: "po_received/detail_form/<?=$row_id?>",
		printTarget		: "po_received/print_doc",
		controlTarget	: "po_received/detail_form_action"
	});
	...
	function load_registration()
	{
		...
		{
			//alert(id);
			otb.fnSettings().sAjaxSource = site_url + "po_received/detail_table_loader/"+$('input[name="i_registration_id"]').val()+"/<?=$row_id?>";
			otb.fnReloadAjax();	
		}
	}
...
<div class="form_area_frame">
   ...
   <tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td><input type="text" readonly="readonly" name="i_create_date" class="date_input" size="15" value="<?=$tp_create_date?>" /></td>
    </tr>
       <tr>
    <td width="158" valign="top">Keterangan</td>
    <td width="10" valign="top">:</td>
    <td width="745" valign="top"><textarea  readonly="readonly" name="i_po_description" id="i_po_description" cols="45" rows="5"><?=$tp_desc?></textarea></td>
    </tr>
