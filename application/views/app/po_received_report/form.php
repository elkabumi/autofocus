...
<div class="form_area_frame">
   ...
   <td>Tanggal awal plain</td>
         <td>:</td>
       <td><input name="i_first_date" readonly="readonly"  type="text" id="i_first_date" value="<?= format_new_date($transaction_plain_first_date) ?>" class="date_input"/></td>
     </tr>
     <tr>
     <td>Tanggal akhir plain</td>
     <td>:</td>
       <td><input name="i_last_date"  readonly="readonly"  type="text" id="i_last_date" value="<?= format_new_date($transaction_plain_last_date) ?>" class="date_input"/></td>
     </tr>
     <tr>
     <td>Tanggal Aktual</td>
     <td>:</td>
       <td><input name="i_actual_date"  readonly="readonly"  type="text" id="i_actual_date" value="<?= format_new_date($transaction_actual_date) ?>" class="date_input"/></td>
     </tr>
     <tr>
