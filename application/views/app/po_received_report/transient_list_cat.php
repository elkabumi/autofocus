...
$(function(){
	createTableFormTransient({
		id 				: "#transient_cat",
		listSource 		: "po_received_report/detail_list_loader_cat/<?=$row_id?>",
		formSource 		: "po_received_report/detail_form_cat/<?=$row_id?>",
		controlTarget	: "po_received_report/detail_form_action_cat",
