...
<table width="100%" class="form_layout">
	<tr>
		...
		<td width="652" req="req"><input type="text" name="i_name" size="50" value="<?=$unit_name?>" /></td>
	  </tr>
	 <tr>
     <td>Keterangan</td>
       <td><textarea name="i_description" type="text" id="i_description"><?=$unit_desc ?></textarea></td>
     </tr>
