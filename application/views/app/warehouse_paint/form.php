...
$(function(){
	createForm({
		id 				: "#id_form_nya", 
		actionTarget	: "warehouse_paint/form_action",
		backPage		: "warehouse_paint",
		nextPage		: "warehouse_paint"
	});
	createLookUp({
		table_id		: "#lookup_table_material",
		table_width		: 400,
		listSource 		: "lookup/material_table_control/2", //1 untuk type  Cat
	...
	function load_satuan()
	{
		...
		$.ajax({
			type: 'POST',
			url: '<?=site_url('warehouse_paint/load_satuan')?>',
			data: data,
			dataType: 'json',
