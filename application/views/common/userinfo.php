...
-->
    ...
    line-height: 1; margin-top:5px; text-shadow: 1px 1px 1px rgba(0,0,0,0.2);" >
                            ...
                            <span style="font-size:11px; font-weight:normal; "><a href="<?=base_url()?>login/logout/1" style="color:#fff; text-shadow: 1px 1px 1px rgba(0,0,0,0.2);"><i class="fa fa-share text-success" style=" color:#fff"></i> Logout</a></span>
                        </div>
                    </div>
...
<table cellpadding="5" cellspacing="0" id="box_user_info">
    ...
    <td>  <span id="clockTimer" style="color:#fff !important; text-shadow: 1px 1px 1px rgba(0,0,0,0.2);">1 Mar 2010 &nbsp; 18:23</span> </td>
    </tr>
    <tr>
